...
def load_data(messages_filepath, categories_filepath):
    """
    Load the data from message and category file and merge

    Args:
        messages_filepath (str): message file path
        categories_filepath (str): category file path
...
def clean_data(df):
    """
    Clean dataframe and prepare category target

    Args:
        df (dataframe): dataframe with message and category info
